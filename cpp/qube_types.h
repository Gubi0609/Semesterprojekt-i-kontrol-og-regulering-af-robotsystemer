...
struct QubeParams {
    ...
    double Jr   = 6.2e-5;    // Arm assembly inertia about motor shaft [kg·m²] (MEASURED 12/05/26)
    ...
    double Jp   = 1.26e-4;   // Pendulum inertia about PIVOT [kg·m²] (MEASURED 12/05/26)
                              // NOTE: pivot-frame! M22 in EOM = Jp directly, no + mp·hLp²
